...
Полную версию этого примера находится в `examples/from_readme.edoc`, так же в `examples` лежат и другие примеры на языке ReverseLang.

![img.png](images/ast_tree.png "AST, соответствующий полной версии примера")
