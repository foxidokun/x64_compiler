...
Поскольку в предыдущем семестре был написан бэкенд для эмулятора стекового процессора (репозитории [бэкенда](https://github.com/foxidokun/ReverseLang) и [эмулятора](https://github.com/foxidokun/cpu)), то можно сравнить производительность нативного x64 кода с эмулируемым кодом стекового процессора.
...
<details>
  <summary><b>Информация о тестовом стенде</b></summary>
